...
- `race_content_time`（PV-01 opt-inのみ）: 過去raceの単独勝者には2着との距離補正時計差を正、非勝者には勝馬との差を負として`±5 sec/1000m`へclipし、half-life 90日で減衰集約した1列。降着・失格raceはcontent更新から除外し、同着勝者は0、DNFは欠損観測とする。default 268列には含めない
