...
The project is currently in the **post-S-rank structured no-odds signal phase**. The corrected baseline, uncertainty, semantic ablations, five limited improvements, standalone rating stages R0–R6, time/margin stages PV-00–PV-06, graded-label GR-001, rolling-origin infrastructure, and all S0/S1 priorities are complete.

Use `docs/model_research_priorities.md`, `docs/experiments/speed_01_condition_adjusted_20260901.md`, and `docs/handoff.md` as the current work queue and decision state. PACE-01's early-position history remains accepted; PACE-02 through PACE-04 are not adopted. SPEED-01's one prequential condition-adjusted time-residual history passed the rolling probability path for both families. Its unchanged 2024 milestone was supported for Binary and directionally consistent for LambdaRank. The current Binary development incumbent is PV-01 plus PACE-01 plus SPEED-01, 256 features, with 2024 NDCG .49763, Top-1 .29695, Log Loss 2.06821, and Brier .82534. The LambdaRank SPEED-01 candidate is rolling-accepted but not milestone-supported; retain a separate conservative 2024 reference. Do not tune the ridge, clip, conditions, PV-01, PACE-01, rating, blend weights, or hyperparameters against 2024. OPP-RECENT was not adopted, HPO-01 retained both parameter sets, fixed 50:50 ENS-01 was rejected, and removing new-horse races from Binary fitting was rejected. Retain the original top-three LambdaRank labels and new-horse races in training. The next modeling hypothesis is COND-01, one shrinkage-aware condition-transition suitability representation evaluated against the SPEED-01 incumbents. New hypotheses must first use rolling-origin; 2024 is milestone-only and 2025 is not used for iterative selection. LIVE-DATA archive groundwork is complete, but the user has deferred actual collection because official JV-Link is Windows-only and the current machine is a Mac. Do not pursue an unofficial Mac transport or JRA Web scraping. Do not jump to DNN, complex betting strategy, or UI without an explicit phase decision.
